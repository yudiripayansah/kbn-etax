...
class Master_mdl extends CI_Model {
	...
	function check_duplicate_npwp($npwp, $org_id){
	...
	function check_duplicate_npwp2($nama_wp, $npwp, $org_id){
...
/*==================================================================TAX=======================================================================*/
	...
	function check_duplic_tahun_rpt($aktif, $tahun){
	...
	function get_format_csv_supplier()
	{
	...
	function get_format_csv_customer()
	{
