...
class Ppn_masa_mdl extends CI_Model
{
    ...
    public function get_pajak_header_id($kode_cabang="", $nama_pajak, $bulan_pajak, $tahun_pajak, $pembetulan_ke="")
    {
    ...
    public function get_data_header($pajak_header_id)
    {
        $this->db->select('*');
        $this->db->from('SIMTAX_PAJAK_HEADERS');
    ...
    public function get_header_id_max($kode_cabang, $nama_pajak, $bulan_pajak, $tahun_pajak)
    {
    ...
    public function get_pajak_lines($pajak_header_id)
    {
    ...
    public function save_z_percent($bulan_pajak, $tahun_pajak, $terutang_ppn, $tidak_terutang, $terutang_tidak_terutang, $z_percent)
    {
    ...
    public function get_pajak_lines_by_id($id)
    {
        $this->db->select('*');
    ...
    public function get_master_wp($kode_cabang, $nama_pajak)
    {
    ...
    public function get_cabang_in_header($kode_cabang="", $nama_pajak, $bulan_pajak, $tahun_pajak, $pembetulan_ke)
    {
        $andCab = "";
        if ($kode_cabang != "") {
    ...
    /* Rekonsiliasi */
    public function get_rekonsiliasi($pajak_header_id, $nama_pajak, $category="", $where_condition=true, $start, $length, $keywords, $orderby)
    {
        ...
        $query            = $this->db->query($sql);
        $queryAll 				= $this->db->query($mainQuery);
        $result['query']  = $query;
    ...
    public function action_cek_row_rekonsiliasi($pajak_header_id, $category="")
    {
        ini_set('memory_limit', '-1');
        ...
        $mainQuery	= "SELECT distinct SPL.PAJAK_LINE_ID, SPL.IS_CHEKLIST, SPL.DL_FS, SPL.KD_JENIS_TRANSAKSI, SPL.NO_DOKUMEN_LAIN, SPL.NO_FAKTUR_PAJAK,
						spl.akun_pajak, spl.dpp, INVOICE_NUM, SMN.STATUS_KSWP,
						".$nvl_wp."
    ...
    public function get_rincian($kode_cabang, $bulan_pajak, $tahun_pajak, $pembetulan_ke)
    {
        if ($bulan_pajak == "1") {
            $tahun_pajak2 = $tahun_pajak-1;
            $bulan_pajak2 = 12;
    ...
    public function get_total_rincian($bulan_pajak, $tahun_pajak, $pembetulan_ke)
    {
        $get_z_percent = $this->get_z_percent($tahun_pajak, $bulan_pajak);
        $row_z         = $get_z_percent['query']->row_array();
        $z_percent     = $row_z['NILAI'];
    ...
    public function update_tahunan($data, $bulan_pajak, $tahun_pajak, $pembetulan_ke)
    {
        $this->db->where('BULAN_PAJAK', $bulan_pajak);
        $this->db->where('TAHUN_PAJAK', $tahun_pajak);
        $this->db->where('PEMBETULAN_KE', $pembetulan_ke);
    ...
    public function get_pmk_tahunan($bulan_pajak, $tahun_pajak, $pembetulan_ke)
    {
    ...
    public function get_detail_summary($pajak_header_id, $category, $pmk=false, $start, $length, $keywords)
    {
        ini_set('memory_limit', '-1');
    ...
    public function get_ntpn($bulan_pajak, $tahun_pajak, $pembetulan_ke, $start, $length, $keywords)
    {
        ini_set('memory_limit', '-1');
    ...
    public function get_total_detail_summary($pajak_header_id, $category)
    {
        ini_set('memory_limit', '-1');
    ...
    public function get_total_pmk($pajak_header_id)
    {
        ini_set('memory_limit', '-1');
    ...
    public function get_pmk_78($pajak_header_id, $inarray = false)
    {
    ...
    public function get_currency($pajak_header_id, $category="Rekonsiliasi")
    {
        if ($category == "Rekonsiliasi") {
    ...
    public function get_total_summary($pajak_header_id, $nama_pajak, $isChecklist, $category="", $start, $length)
    {
        ini_set('memory_limit', '-1');

        if ($isChecklist == 1) {
            $where = " AND SPL.IS_CHEKLIST = 1";
        } elseif ($isChecklist == 0) {
    ...
    public function add_ntpn($data, $tanggal_setor, $tanggal_lapor)
    {
    ...
    public function check_ntpn($id, $bulan, $tahun, $pembetulan, $ntpn)
    {
        $andID = "";
        if ($id !="") {
            $andID = " AND ID != ".$id;
    ...
    public function update_ntpn($id, $data, $tanggal_setor, $tanggal_lapor)
    {
        $date   = date("Y-m-d H:i:s");
    ...
    public function delete_ntpn($id)
    {
    ...
    public function update_rekonsiliasi($id, $data, $tanggal_dokumen_lain="", $tanggal_faktur_pajak="", $tanggal_approval="", $tanggal_faktur_asal="")
    {
        $date   = date("Y-m-d H:i:s");
    ...
    public function add_rekonsiliasi($data, $tanggal_dokumen_lain="", $tanggal_faktur_pajak="", $tanggal_approval="", $tanggal_faktur_asal="")
    {
        $date   = date("Y-m-d H:i:s");
    ...
    public function update_saldo($pajak_header_id, $data)
    {
        $date   = date("Y-m-d H:i:s");
    ...
    public function action_get_selectAll()
    {
    ...
    public function submit_rekonsiliasi($pajak_header_id, $nama_pajak, $username)
    {
    ...
    public function get_closing($kode_cabang, $tahun_pajak, $pembetulan_ke, $start, $length, $keywords)
    {
        ini_set('memory_limit', '-1');
        $where  = "";
        if ($keywords) {
    ...
    public function action_save_closing($pajak_header_id, $period_id, $nama_pajak, $status, $username)
    {
        if ($status == "Open") {
    ...
    public function get_status($kode_cabang="", $nama_pajak="", $bulan_pajak="", $tahun_pajak="", $pembetulan_ke="", $start, $length)
    {
        ini_set('memory_limit', '-1');
        $whereCabang     = "";
        $wherePajak      = "";
    ...
    public function jumlah_ppn($pajak_header_id, $nama_pajak, $type="", $status="")
    {
        ini_set('memory_limit', '-1');
    ...
    public function insert_z_percent($tahun, $terutang_ppn, $tidak_terutang_ppn)
    {
    ...
    public function get_z_percent($tahun, $bulan)
    {
    ...
    public function get_z_percent_all($tahun="", $start, $length)
    {
        ini_set('memory_limit', '-1');
    ...
    public function delete_efaktur_lines($pajak_header_id)
    {
    ...
    public function delete_pajak_lines($pajak_line_id)
    {
        $sql = "DELETE FROM SIMTAX_PAJAK_LINES
    ...
    public function get_history($pajak_header_id, $start, $length)
    {
        ini_set('memory_limit', '-1');
    ...
    public function get_approval($pajak_header_id="", $kode_cabang="", $nama_pajak, $bulan_pajak, $tahun_pajak, $pembetulan_ke, $category="", $start, $length, $keywords)
    {
        ini_set('memory_limit', '-1');
        $where = "";
    ...
    public function save_approval($pajak_header_id="", $nama_pajak, $st, $keterangan, $username, $approval_category)
    {
    ...
    public function action_get_start($kode_cabang="", $nama_pajak, $bulan_pajak, $tahun_pajak, $pembetulan_ke)
    {
        if ($kode_cabang != "") {
            $whereCabang = " AND SPH.KODE_CABANG= '".$kode_cabang."'";
        } else {
    ...
    public function get_pembetulan($kode_cabang, $nama_pajak, $bulan_pajak, $tahun_pajak, $pembetulan_ke, $start, $length, $keywords)
    {
        ini_set('memory_limit', '-1');
        $where = "";
        if ($keywords) {
    ...
    public function action_save_pembetulan($header_id_max)
    {
    ...
    public function action_delete_pembetulan()
    {
    ...
    public function get_download($pajak_header_id="", $kode_cabang="", $nama_pajak, $bulan_pajak, $tahun_pajak, $pembetulan_ke, $category, $start, $length, $keywords, $categorys)
    {
        ini_set('memory_limit', '-1');
        $where = "";
    ...
    public function get_data_csv($pajak_header_id, $nama_pajak, $category, $dilaporkan)
    {
        if ($category == "dokumen_lain") {
            $whereCategory = " AND SPL.DL_FS = '".$category."'";
        } else {
    ...
    public function get_csv($pajak_header_id="", $kode_cabang="", $nama_pajak, $bulan_pajak, $tahun_pajak, $pembetulan_ke, $category_download, $jenis_dokumen, $creditable="", $groupByInvoiceNUm=false)
    {
        if ($pajak_header_id != "") {
            $where = " WHERE SPL.PAJAK_HEADER_ID = ".$pajak_header_id;
        } else {
    ...
    public function check_duplicate_faktur_doklain($pajak_header_id, $nama_pajak, $category="")
    {
        if ($nama_pajak == "PPN MASUKAN") {
            $fieldAdded = "";
        } else {
    ...
    public function get_by_duplicate_invoice($pajak_header_id)
    {
        if (is_array($pajak_header_id)) {
            $implode = 0;
