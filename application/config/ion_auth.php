...
*/
$config['tables']['users']          = 'SIMTAX_USER';
$config['tables']['groups']         = 'SIMTAX_GROUPS';
$config['tables']['menus']          = 'SIMTAX_DYN_MENU';
$config['tables']['users_groups']   = 'SIMTAX_USER_GROUPS';
$config['tables']['groups_menus']   = 'SIMTAX_GROUP_MENU';
$config['tables']['login_attempts'] = 'SIMTAX_LOGIN_ATTEMPTS';
...
$config['admin_email']                = "badar.nento@gmail.com"; // Admin Email, admin@example.com
...
$config['default_password']        = 'IPCPELINDO2';	// Error message end delimiter
