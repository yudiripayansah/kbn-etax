			...
			<div class="col-md-4">
                <div class="form-group">
                    ...
                    <select id="kd_cabang" name="kd_cabang" class="form-control" autocomplete="off">
                        <?php if($this->kode_cabang != "000"){ ?>
                        <option value="<?php echo $this->kode_cabang ?>"><?php echo get_nama_cabang($this->kode_cabang) ?></option>
                        <?php
                    	}
                        else{
										...
										<table width="100%" class="display  cell-border stripe hover small" id="tabledata"> 
											<thead>
												<tr>
													...
													<th>OLEH</th>
													<th>STATUS</th>
													<!-- <th>TANGGAL SUBMIT SUPPLIER</th>
													<th>TANGGAL APPROVE SUPPLIER</th>
    ...
    $(document).ready(function() {
		...
		Pace.track(function(){  
		   $('#tabledata').DataTable({
			...
			"processing"	: true,
			"ajax"			: {
								 "url"  		: baseURL + 'ppn_masa/load_status',
								 "type" 		: "POST",								
								 "data"			: function ( d ) {
