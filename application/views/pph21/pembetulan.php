                        ...
                        <div class="panel-heading">
                           <div class="row">
								...
								<div class="col-lg-6">
									...
									<button id="btnAdd" class="btn btn-default btn-rounded custom-input-width" type="button" data-toggle="modal" data-target="#modal-wp"><i class="fa fa-pencil-square-o"></i> Add New</button>	
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger waves-effect" data-dismiss="modal"><i class="fa fa-times-circle"></i> Batal</button>
        <button type="button" class="btn btn-info waves-effect" id="btnOpen"><i class="fa fa-save"></i> Buka</button>
      </div>
    </div>
  </div>
</div>
    ...
    $(document).ready(function() {
		 ...
		 Pace.track(function(){  
		   $('#tabledata').DataTable({
			...
			"processing"	: true,
			"ajax"			: {
								 "url"  		: "<?php echo site_url('pph21/load_pembetulan'); ?>",
								 "type" 		: "POST",
								 "data"			: function ( d ) {
	...
	$("#btnOpen").click(function(){	
		...
		vp = parseInt(vfpembetulan)- parseInt(1);
			...
			callback: function (result) {
				if(result) {					
					$.ajax({
						url		: "<?php echo site_url('pph21/save_pembetulan') ?>",
						type	: "POST",
	...
	$("#btnDelete").click(function(){
		  bootbox.confirm({
			...
			callback: function (result) {
				if(result) {
					$.ajax({
						url		: "<?php echo site_url('pph21/delete_pembetulan') ?>",
						type	: "POST",
