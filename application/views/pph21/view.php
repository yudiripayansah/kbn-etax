							...
							<div class="col-lg-12 col-sm-12 col-xs-12">
								<div class="white-box boxshadow animated slideInDown">			
									<ul class="nav customtab nav-tabs" role="tablist">
										...
										<li role="presentation" class=""><a id="aDetailSummary" href="#tab-detail" aria-controls="tab-detail" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-user"></i></span> <span class="hidden-xs"><i class="fa fa-dropbox fa-fw"></i> Data Tidak Dilaporkan</span></a></li>
									</ul>
    ...
    $(document).ready(function() {
		...
		Pace.track(function(){  
		   $('#tabledata').DataTable({
			...
			"processing"	: true,
			"ajax"			: {
								 "url"  		: "<?php echo site_url('pph21/load_view'); ?>",
								 "type" 		: "POST",								
								 "data"			: function ( d ) {
			 ...
			 "language"		: {
					...
					"processing"	:' <img src="<?php echo base_url(); ?>assets/view/simtax/css/images/loading2.gif">',
					"search"		: "_INPUT_"
				},
			   "columns": [
		...
		function getDataLines()
		{
			...
			if ( ! $.fn.DataTable.isDataTable( '#tabledata-lines' ) ) {
				...
				"processing"	: true,
				"ajax"			: {
									 "url"  		: "<?php echo site_url('pph21/load_rekonsiliasi_detail'); ?>",
									 "type" 		: "POST",								
									 "data"			: function ( d ) {
				...
				"columnDefs": [ 
					 {
						"targets": [ 2,3,4,5,6, 7, 8,9,13,14,15,16,18,23,24,25,26 ],
						"visible": false
					} 
				],		
				 "scrollY"			: 480, 
				...
				$('#tabledata-lines_filter input[type="search"]').attr('placeholder','Cari No  Nama WP ...').css({'width':'230px','display':'inline-block'}).addClass('form-control input-sm');		
	...
	function getHistory()
	{
		if ( ! $.fn.DataTable.isDataTable( '#tabledata-history' ) ) {
		 $('#tabledata-history').DataTable({
			...
			"processing"	: true,
			"ajax"			: {
								 "url"  		: "<?php echo site_url('pph21/load_history'); ?>",
								 "type" 		: "POST",								
								 "data"			: function ( d ) {
										d._searchBulan 		= vbulan;
										d._searchTahun 		= vtahun;
