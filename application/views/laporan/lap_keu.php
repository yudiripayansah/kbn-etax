			...
			<div class="col-lg-2">
				...
				<div class="col-lg-2">
					<div class="form-group">
						...
						?>				
							<option value='13' data-name='ADJ1'>ADJ1</option>	
							<option value='14' data-name='ADJ2'>ADJ2</option>	
							<option value='15' data-name='ADJ3'>ADJ3</option>		
						</select> 
					</div>
				</div>
				<div class="col-lg-2">
...
$(document).ready(function() {
	...
	$("#btnView").on("click", function(){
		var url 	="<?php echo site_url(); ?>laporan/cetak_lap_keu";
