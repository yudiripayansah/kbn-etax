...
<script>
	...
	$("#btnView").on("click", function(){
		var url 	="<?php echo site_url(); ?>laporan/cetak_rekap_kurang_lebih";
		vtahun				= $("#tahun").val();
		vbulan				= $("#bulan").val();
		vpembetulan			= $("#pembetulanKe").val();
		kd_cabang			= $("#kd_cabang").val();
		window.open(url+'?tahun='+vtahun+'&bulan='+vbulan+'&pembetulanKe='+vpembetulan+'&kd_cabang='+kd_cabang, '_blank');
		window.focus();
	});	
