			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="input-group">
							<input type="text" class="form-control datepicker-autoclose" id="tanggal_setor" name="tanggal_setor" placeholder="dd/mm/yyyy" data-toggle="validator" data-error="Pilih Tanggal Setor!" required > <span class="input-group-addon"><i class="icon-calender"></i></span> 
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="input-group">
							<input type="text" class="form-control datepicker-autoclose" id="tanggal_lapor" name="tanggal_lapor" placeholder="dd/mm/yyyy" data-toggle="validator" data-error="Pilih Tanggal Lapor!" required ><span class="input-group-addon"><i class="icon-calender"></i></span> 
...
$(document).ready(function() {
	...
	$('#list-data .dataTables_filter input[type="search"]').attr('placeholder','Cari NTPN...').css({'width':'230px','display':'inline-block'}).addClass('form-control input-sm');
