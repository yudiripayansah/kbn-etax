<div class="container-fluid">
	<div class="row bg-title">
		<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
		  <div class="page-title"><b><?php echo $subtitle ?></b> || Kantor Cabang <span class="label label-danger">Tanjung Priok</span></div> 
		</div>
        <div class="col-lg-7 col-sm-7 col-md-7 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="#">PPH 23/26</a></li>
			 ...
			 <div class="col-lg-3">
				<div class="form-group">
					...
					<select class="form-control" id="jenisPajak" name="jenisPajak">
						<option value="30901101" data-name="PPh Pasal 15" >PPh Pasal 15</option>
						<option value="30901201" data-name="PPh Pasal 21" >PPh Pasal 21</option>
						<option value="30901211" data-name="PPh Pasal 21 Final" >PPh Pasal 21 Final</option>
						<option value="30901221" data-name="PPh Pasal 23" >PPh Pasal 23</option>
						<option value="30901222" data-name="PPh Pasal 22" >PPh Pasal 22</option>
						<option value="30901301" data-name="PPh Pasal 23 dan 26" selected >PPh Pasal 23 dan 26</option>
						<option value="30901311" data-name="PPh Pasal 26" >PPh Pasal 26</option>
						<option value="30901401" data-name="PPh Pasal 25" >PPh Pasal 25</option>
						<option value="30901501" data-name="PPh Badan" >PPh Badan</option>
						<option value="30901701" data-name="PPh Final Pasal 4 ayat (2)" >PPh Final Pasal 4 ayat (2)</option>
					</select> 
				</div>
			 </div>
			 <div class="col-lg-2">	
    ...
    $(document).ready(function() {
		...
		valueAdd();
		 ...
		 $('#tabledata').DataTable({			
			...
			"processing"	: true,
			"ajax"			: {
								 "url"  		: "<?php echo site_url('pph/load_bukti_potong'); ?>",
								 "type" 		: "POST",
								 "data"			: function ( d ) {
		...
		$("#btnSave").click(function(){				
			$.ajax({
				url		: "<?php echo site_url('pph/save_bukti_potong') ?>",
				type	: "POST",
	...
	$("#btnDelete").click(function(){
		  bootbox.confirm({
			...
			callback: function (result) {
				if(result) {
					$.ajax({
						url		: "<?php echo site_url('pph/delete_bukti_potong') ?>",
						type	: "POST",
						data	: $('#form-wp').serialize(),
						beforeSend	: function(){
							 $("body").addClass("loading");					
