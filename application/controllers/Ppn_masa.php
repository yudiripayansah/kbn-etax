...
class Ppn_masa extends CI_Controller
{
    ...
    public function rekonsiliasi_masukan()
    {
        if ($this->ion_auth->is_admin()) {
            $permission = true;
        } elseif (in_array("ppn_masa/rekonsiliasi_masukan", $this->session->userdata['menu_url'])) {
            $permission = true;
        } else {
            $permission = false;
        }
    ...
    public function rekonsiliasi_keluaran()
    {
        if ($this->ion_auth->is_admin()) {
            $permission = true;
        } elseif (in_array("ppn_masa/rekonsiliasi_keluaran", $this->session->userdata['menu_url'])) {
            $permission = true;
        } else {
            $permission = false;
        }
    ...
    public function detail_jurnal_transaksi()
    {
        if ($this->ion_auth->is_admin()) {
            $permission = true;
        } elseif (in_array("ppn_masa/detail_jurnal_transaksi", $this->session->userdata['menu_url'])) {
            $permission = true;
        } else {
            $permission = false;
        }
    ...
    public function load_rekonsiliasi($header_id="")
    {
        ...
        if ($this->ion_auth->is_admin()) {
            $permission = true;
        } elseif (in_array($menu_pajak, $this->session->userdata['menu_url'])) {
            $permission = true;
        } else {
            $permission = false;
        }
        ...
        if ($permission === true) {
            ...
            if ($rowCount > 0) {
                ...
                $npwpAll = array();
                foreach ($queryAll->result_array() as $rowAll) {
                    if (!in_array($rowAll['NPWP1'], $npwpAll)) {
                        array_push($npwpAll, $rowAll['NPWP1']);
                    }
                }
    ...
    public function load_total_summary($isChecklist)
    {
        ...
        if ($this->ion_auth->is_admin()) {
            ...
            $permission = true;
        } elseif (in_array("ppn_masa/view_status", $this->session->userdata['menu_url'])) {
            $permission = true;
        } else {
            $permission = false;
        }
    ...
    public function load_summary_rekonsiliasiAll1()
    {
        if ($this->input->post('_searchCabang')) {
            $kode_cabang = $this->input->post('_searchCabang');
        } else {
        ...
        if ($this->ion_auth->is_admin()) {
            ...
            $permission = true;
        } elseif (in_array("ppn_masa/download_cetak", $this->session->userdata['menu_url'])) {
            $permission = true;
        } elseif (in_array("ppn_masa/download_kompilasi", $this->session->userdata['menu_url'])) {
            $permission = true;
        } elseif (in_array("ppn_masa/approval_supervisor", $this->session->userdata['menu_url'])) {
            $permission = true;
        } elseif (in_array("ppn_masa/approval_pusat", $this->session->userdata['menu_url'])) {
            $permission = true;
        } elseif (in_array("ppn_masa/view_status", $this->session->userdata['menu_url'])) {
            $permission = true;
        } else {
    ...
    public function load_total_rincian()
    {
        if ($this->input->post('_category') == "approval_cabang") {
            $kode_cabang = $this->kode_cabang;
        } else {
    ...
    public function load_z_percent_table()
    {
    ...
    public function load_z_percent()
    {
        $bulan_pajak   = $this->input->post('_searchBulan');
        $tahun_pajak   = $this->input->post('_searchTahun');
    ...
    public function load_detail_summary()
    {
        if ($this->input->post('_searchCabang')) {
            $kode_cabang = $this->input->post('_searchCabang');
        } else {
    ...
    public function load_total_detail_summary()
    {
        if ($this->input->post('_searchCabang')) {
            $kode_cabang = $this->input->post('_searchCabang');
        } else {
    ...
    public function load_total_pmk()
    {
        if ($this->input->post('_searchCabang')) {
            $kode_cabang = $this->input->post('_searchCabang');
        } else {
    ...
    public function save_uraian_pekerjaan()
    {
    ...
    public function save_z_percent()
    {
    ...
    public function load_total_rekonsiliasi()
    {
    ...
    public function check_rekonsiliasi($category="checklist")
    {
        if ($this->ion_auth->is_admin()) {
            $permission = true;
        } elseif (in_array("ppn_masa/rekonsiliasi_masukan", $this->session->userdata['menu_url'])) {
    ...
    public function export_format_csv()
    {
    ...
    public function delete_rekonsiliasi()
    {
    ...
    public function validation_rekonsiliasi($pajak_header_id, $nama_pajak)
    {
        ...
        if ($data2) {
            ...
            foreach ($data2->result_array() as $row) {
                ...
                $hasilKswpFaktur ="Nomor ".$recordsKswp." Status KSWP pada form EFAKTUR Belum Valid";
                // }
                // else{
                // 	if ($row['IS_CHEKLIST']==1){
        ...
        if ($fakturAda == true && $doklainAda == true) {
            $result['data'] = $hasilFaktur ."<br>".$hasilDoklain.'<br>';
        } else {
            if ($fakturAda == true && $doklainAda == false) {
                $result['data'] = $hasilFaktur.'<br>';
            } elseif ($doklainAda == true && $fakturAda == false) {
                $result['data'] = $hasilDoklain.'<br>';
            } else {
                $masihKosong = false;
            }
        }

        if ($fakturKswp == true && $doklainKswp == true) {
            $result['data'] .= $hasilKswpFaktur.'<br>'.$hasilKswpDoklain;
        } else {
            if ($fakturKswp == true && $doklainKswp == false) {
                $result['data'] .= $hasilKswpFaktur;
            } elseif ($doklainKswp == true && $fakturKswp == false) {
                $result['data'] .= $hasilKswpDoklain;
            } else {
                $kswpBelumValid = false;
            }
        }

        if ($masihKosong || $kswpBelumValid) {
            $result['st'] = 1;
            echo json_encode($result);
            die();
        } else {
    ...
    public function submit_rekonsiliasi()
    {
        $kode_cabang   = $this->kode_cabang;
    ...
    public function load_master_wp($nama_pajak)
    {
        $nama_pajak = str_replace('%20', ' ', $nama_pajak);
    ...
    public function approval_supervisor()
    {
        if ($this->ion_auth->is_admin()) {
            $permission = true;
        } elseif (in_array("ppn_masa/approval_supervisor", $this->session->userdata['menu_url'])) {
    ...
    public function pembetulan()
    {
        if ($this->ion_auth->is_admin()) {
            $permission = true;
        } elseif (in_array("ppn_masa/pembetulan", $this->session->userdata['menu_url'])) {
            $permission = true;
        } else {
            $permission = false;
        }
    ...
    public function load_pembetulan()
    {
        if ($this->ion_auth->is_admin()) {
            $permission = true;
        } elseif (in_array("ppn_masa/pembetulan", $this->session->userdata['menu_url'])) {
    ...
    public function open_pembetulan()
    {
    ...
    public function delete_pembetulan()
    {
    ...
    public function export_csv($category_download, $kode_cabang, $nama_pajak, $bulan_pajak, $tahun_pajak, $pembetulan_ke, $category, $creditable="", $withAkun = 0)
    {
        ini_set('memory_limit', '-1');
    ...
    public function closing()
    {
        if ($this->ion_auth->is_admin()) {
            $permission = true;
        } elseif (in_array("ppn_masa/closing", $this->session->userdata['menu_url'])) {
            $permission = true;
        } else {
            $permission = false;
        }
