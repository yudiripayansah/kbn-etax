...
class Master extends CI_Controller {
	...
	function tambah_pr() 
   {
	...
	function export_format_csv_supplier() {
	...
	function export_format_csv_customer() {
    	$this->load->helper('csv_helper');		
		$date	    = date("Y-m-d H:i:s");
        $export_arr = array();
        $data       = $this->Master_mdl->get_format_csv_customer();
		$title = array('CUSTOMER_ID','CUSTOMER_NAME','ALIAS_CUSTOMER','CUSTOMER_NUMBER','NPWP','OPERATING_UNIT','CUSTOMER_SITE_ID','CUSTOMER_SITE_NUMBER','CUSTOMER_SITE_NAME',
